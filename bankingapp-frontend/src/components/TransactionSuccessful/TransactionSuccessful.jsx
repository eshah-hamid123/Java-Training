...
const TransactionSuccessful = () => {
    ...
    return (
        <Layout>
            <Container component="main" maxWidth="md" className="success-transaction-container">
                <Paper elevation={6} className="success-transaction-paper">
                    <Box display="flex" flexDirection="column" alignItems="center" p={3}>
                        <CheckCircleIcon color="success" fontSize="large" className="success-icon" />
                        <Typography variant="h4" gutterBottom className="success-transaction-title">
